...
# python bin/preprocess.py --config ./bin/parallel_wavegan.v1.yaml --dumpdir dump
...
def main():
    ...
    parser.add_argument("--rootdir", default='/home/ahgmuse/database/audio_48k/f1', type=str,
