...
# python bin/train.py --config bin/parallel_wavegan.v1.yaml --outdir exp
...
def main():
    ...
    parser.add_argument("--train-dumpdir", default='/home/ahgmuse/database/mel/f1/train', 
                        type=str,help="directory including training data. "
                             "you need to specify either train-*-scp or train-dumpdir.")
    ...
    parser.add_argument("--dev-dumpdir", default='/home/ahgmuse/database/mel/f1/dev', 
                        type=str,help="directory including development data. "
                             "you need to specify either dev-*-scp or dev-dumpdir.")
